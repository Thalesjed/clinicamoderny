                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '6bd3y9f9' /* Fill out the information below... */,
                            ),
                  ...
                  Padding(
                    ...
                    child: FlutterFlowDropDown<String>(
                      ...
                      options: [
                        FFLocalizations.of(context).getText(
                          '1gml79p9' /* Doctors Visit */,
                        ),
                        FFLocalizations.of(context).getText(
                          '69eydvnj' /* Routine Checkup */,
                        ),
                        FFLocalizations.of(context).getText(
                          '5knuip1p' /* Scan/Update */,
                        )
                      ],
                      onChanged: (val) =>
                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            context.goNamed('myAppointments');
                          },
                          text: FFLocalizations.of(context).getText(
                            '8c4fnuop' /* Book Now */,
                          ),
