...
class _CreateWidgetState extends State<CreateWidget> {
  ...
  void initState() {
    ...
    _model.textFieldSolucaoController ??= TextEditingController();
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  controller: _model.textFieldSolucaoController,
                  autofocus: true,
                  obscureText: false,
                  decoration: InputDecoration(
                    hintText: FFLocalizations.of(context).getText(
                  ...
                  style: FlutterFlowTheme.of(context).bodyMedium,
                  validator: _model.textFieldSolucaoControllerValidator
                      .asValidator(context),
                ),
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          final artigosdesaudeCreateData =
                              createArtigosdesaudeRecordData(
                            nome: _model.textFieldNomeController.text,
                            tratamentos: _model.textFieldSolucaoController.text,
                          );
                          await ArtigosdesaudeRecord.collection
                              .doc()
                              .set(artigosdesaudeCreateData);
                          setState(() {
                            _model.textFieldNomeController?.clear();
                            _model.textFieldSolucaoController?.clear();
                          });
                        },
                        text: FFLocalizations.of(context).getText(
                          'pjewr4em' /* Create Task */,
                        ),
                        options: FFButtonOptions(
                          width: 130.0,
                          height: 40.0,
