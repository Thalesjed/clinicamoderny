                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'cp0728th' /* Edit the fields below in order... */,
                                  ),
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'nd16zpm5' /* Emails will be sent to: */,
                            ),
                        ...
                        Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            ...
                            options: [
                              FFLocalizations.of(context).getText(
                                'ffl2ttlc' /* Type of Appointment */,
                              ),
                              FFLocalizations.of(context).getText(
                                'cl1jujvr' /* Doctors Visit */,
                              ),
                              FFLocalizations.of(context).getText(
                                'jixya9ro' /* Routine Checkup */,
                              ),
                              FFLocalizations.of(context).getText(
                                'r5knkq2z' /* Scan/Update */,
                              )
                            ],
                            onChanged: (val) =>
