                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              children: [
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'uozlphud' /* Fill out the information below... */,
                                      ),
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'ibosesf8' /* Emails will be sent to: */,
                                ),
                            ...
                            Padding(
                              ...
                              child: FlutterFlowDropDown<String>(
                                ...
                                options: [
                                  FFLocalizations.of(context).getText(
                                    'bur8g2qh' /* Doctors Visit */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    'zczqcl1n' /* Routine Checkup */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    'tajo15ug' /* Scan/Update */,
                                  )
                                ],
                                onChanged: (val) =>
