                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'uwe0wh7z' /* Upload a photo for us to easil... */,
                        ),
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: FFLocalizations.of(context).getText(
                        '40idm7sp' /* What types of allergies do the... */,
                      ),
                      hintStyle: FlutterFlowTheme.of(context)
                          .bodyMedium
                          .override(
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: FFLocalizations.of(context).getText(
                        'bk2d3knp' /* Please enter a valid email... */,
                      ),
                      hintStyle: FlutterFlowTheme.of(context)
                          .bodyMedium
                          .override(
