...
import 'schema/artigosdesaude_record.dart';
...
export 'schema/artigosdesaude_record.dart';
...
/// Functions to query ArtigosdesaudeRecords (as a Stream and as a Future).
Future<int> queryArtigosdesaudeRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ArtigosdesaudeRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ArtigosdesaudeRecord>> queryArtigosdesaudeRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<ArtigosdesaudeRecord>> queryArtigosdesaudeRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<ArtigosdesaudeRecord>> queryArtigosdesaudeRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
